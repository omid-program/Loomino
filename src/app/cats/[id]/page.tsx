	...
	return (
		<Container>
			<div>
				...
				<div className="px-1 py-2 my-3 w-1/6 mx-auto text-center border-2 border-textMainMuted rounded-sm shadow-md shadow-textMainMuted font-bold">
					<h2 className="text-xl">دسته بندی : {catData.perTitle}</h2>
				</div>
				<div className="px-2 py-4 my-3 w-2/3 mx-auto text-right border-2 border-textMainMuted rounded-sm shadow-md shadow-textMainMuted ">
					<p>{catData.perDesc}</p>
				</div>
