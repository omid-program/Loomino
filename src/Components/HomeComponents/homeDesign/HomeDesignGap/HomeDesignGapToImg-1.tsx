...
function HomeDesignGapToImg(props: THomeDesignGapToPageProps) {
	return (
		<div className="grid grid-cols-7 gap-0 h-36 md:h-[420px] ">
			...
			<div className="col-span-3  border-y-2 border-primary mx-0 text-center grid grid-rows-3 h-36 md:h-[420px]">
				<div>
				...
				<div>
					<p className="text-sm  text-textMainMuted my-1 md:text-base ">{props.description}</p>
					<p className="text-textMainMuted my-1 hidden md:block">{props.secendDescription}</p>
				</div>
