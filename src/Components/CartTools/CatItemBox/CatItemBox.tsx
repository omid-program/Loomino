import { TCatDatas, TCatItemBoxProps } from '@/types';
import Link from 'next/link';
import React from 'react';

export default function CatItemBox(props:TCatItemBoxProps) {
  const{defImg , perTitle  , perMiniDescription ,id} =  props
	return (
		<div className=" rounded border-2 border-sky-500 flex flex-col justify-center items-center ">
